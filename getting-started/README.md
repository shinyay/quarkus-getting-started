...
```
It produces the `getting-started-1.0.0-SNAPSHOT-runner.jar` file in the `/build` directory.
...
The application is now runnable using `java -jar build/getting-started-1.0.0-SNAPSHOT-runner.jar`.
